...
pip install opencv-python hashlib

---


## Features
- Secure data embedding using SHA-256 hashing.
- Maintains image quality while hiding data.
- Compatible with common image formats (JPEG, PNG, etc.).
- User-friendly scripts for encryption and decryption.

## Installation
1. Clone the repository:
   ```bash
   git clone https://github.com/Imohammedsamee/Cyber-Security.git
